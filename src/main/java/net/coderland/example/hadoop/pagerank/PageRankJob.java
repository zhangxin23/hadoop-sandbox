package net.coderland.example.hadoop.pagerank;
...
public class PageRankJob {
    ...
    private static Map<String, String> peoplerank() {
        ...
        path.put("page", "sample/pagerank/people.csv");// 本地的数据文件
        path.put("pr", "sample/pagerank/peoplerank.csv");// 本地的数据文件
    ...
    private static Map<String, String> pagerank() {
        Map<String, String> path = new HashMap<String, String>();
        path.put("page", "sample/pagerank/page.csv");// 本地的数据文件
        path.put("pr", "sample/pagerank/pr.csv");// 本地的数据文件
        path.put("nums", "4");// 页面数
        path.put("d", "0.85");// 阻尼系数
