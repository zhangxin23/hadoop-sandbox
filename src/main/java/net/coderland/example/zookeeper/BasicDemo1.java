package net.coderland.example.zookeeper;
...
public class BasicDemo1 {
    ...
    public static void main(String[] args) throws IOException, KeeperException, InterruptedException {
        ...
        if (zk.exists("/node", true) == null) {
            zk.create("/node", "coderland".getBytes(), Ids.OPEN_ACL_UNSAFE, CreateMode.PERSISTENT);
            System.out.println("create /node coderland");
            // 查看/node节点数据
